...
BasicGame.Game.prototype = {
	...
	create: function () {
        ...
        this.timetext = this.add.bitmapText(this.world.centerX -85 ,10,'font','0',30);
    ...
    nextLevel : function(){
        ...
        this.time.events.add(Phaser.Timer.SECOND, function(){
			...
			if(score < parseInt(localStorage.getItem("mintime"))) {
		   
		   localStorage.setItem("mintime",score);
		   
		   }
		   
		if(clicks < parseInt(localStorage.getItem("minclicks"))) {
		   
		   localStorage.setItem("minclicks",clicks);
