...
BasicGame.MainMenu.prototype = {
	...
	{
		localStorage.setItem("mintime",3276);
	}
 
	if(localStorage.getItem("minclicks") === null)
	{
		localStorage.setItem("minclicks",3276);
	}
		...
		this.musicButton = this.add.button(this.world.centerX, this.world.height - 10, 'musicbutton', this.disprog, this, 1,0,2);
	...
	disprog: function (pointer) {

		this.music.stop();

		this.state.start('progress');
...
BasicGame.progress = function (game) {


};

BasicGame.progress.prototype = {
